      ...
      <div className="flex gap-2 mb-5 flex-wrap">
        {['todos', ...STATUS_OPTS.map(s => s.key)].map(k => (
          <button key={k} onClick={() => setFilterStatus(k)}
            ...
            style={filterStatus === k ? { backgroundColor: brandColor, color: '#fff' } : { backgroundColor: '#17171f', color: '#6b6b80', border: '1px solid #2a2a38' }}>
...
export default function Acompanhamento() {
  return <AppLayout module="acompanhamento"><AcompContent /></AppLayout>
}
